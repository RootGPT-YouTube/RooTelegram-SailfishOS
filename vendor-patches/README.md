...
Restano da produrre i `.pri` (`vendor/tg_owt/abseil-cpp.pri`, `tg_owt.pri`, `vendor/tgcalls/tgcalls.pri`,
inclusi da `harbour-rootelegram.pro:484-486`) e soprattutto **`libtg_owt.a` per arm64 e arm**, che si
compila con cmake dal checkout: è la parte lunga, ma è *lavoro*, non informazione perduta.
