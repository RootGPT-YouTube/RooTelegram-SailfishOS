...
IT = {
    ...
    # 2.4: Info messaggio (#1) + Chat archiviate (#4)
    "Message info": "Info messaggio",
    "Sent": "Inviato",
    "Edited": "Modificato",
    "Scheduled": "Programmato",
    "Sender": "Mittente",
    "Author signature": "Firma autore",
    "Via bot": "Via bot",
    ...
    "Album ID": "ID album",
    "When the recipient comes online": "Quando il destinatario è online",
    "Unknown": "Sconosciuto",
    "Photo": "Foto",
    "Video": "Video",
    ...
    "Archive chat": "Archivia chat",
    "Unarchive": "Disarchivia",
    "No archived chats": "Nessuna chat archiviata",
    "Long-press a chat in the main list and choose Archive.":
        "Tieni premuta una chat nell'elenco principale e scegli «Archivia».",
    "%n chat(s)": ("%n chat", "%n chat"),
}
...
DE = {
    ...
    # 2.4: Nachrichteninfo (#1) + Archivierte Chats (#4)
    "Message info": "Nachrichteninfo",
    "Sent": "Gesendet",
    "Edited": "Bearbeitet",
    "Scheduled": "Geplant",
    "Sender": "Absender",
    "Author signature": "Autorensignatur",
    "Via bot": "Über Bot",
    "Forwarded from": "Weitergeleitet von",
    "Original date": "Ursprüngliches Datum",
    "Views": "Aufrufe",
    "Forwards": "Weiterleitungen",
    "Message ID": "Nachrichten-ID",
    "Album ID": "Album-ID",
    "When the recipient comes online": "Wenn der Empfänger online ist",
    "Unknown": "Unbekannt",
    "Photo": "Foto",
    "Video": "Video",
    ...
    "Long-press a chat in the main list and choose Archive.":
        "Halte einen Chat in der Hauptliste gedrückt und wähle „Archivieren“.",
    "%n chat(s)": ("%n Chat", "%n Chats"),
}
