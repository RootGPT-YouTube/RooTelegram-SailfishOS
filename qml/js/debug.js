...
.pragma library
.import WerkWolf.RooTelegram 1.0 as RooTelegram
var enabled = RooTelegram.DebugLog.enabled;
...
RooTelegram.DebugLog.enabledChanged.connect(function() {
    enabled = RooTelegram.DebugLog.enabled;
    if(enabled) {
        log = console.log;
